...
import com.azhariharisalhamdi.ODIR5K.tflite.Classifier.Recognition;
...
public class ClassifierTest {
  ...
  public void classificationResultsShouldNotChange() throws IOException {
    ...
    Classifier classifier = Classifier.create(activity, Model.MULTI_LABEL_MODEL, Device.CPU, 1);
