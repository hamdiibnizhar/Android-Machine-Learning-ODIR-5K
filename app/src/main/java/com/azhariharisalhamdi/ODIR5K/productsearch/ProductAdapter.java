...
import com.azhariharisalhamdi.ODIR5K.productsearch.ProductAdapter.ProductViewHolder;
...
//          LayoutInflater.from(parent.getContext()).inflate(R.layout.product_item, parent, false);
          LayoutInflater.from(parent.getContext()).inflate(R.layout.product_item_simple, parent, false);
