...
public abstract class Classifier {
  ...
  public static Classifier create(Activity activity, Model model, Device device, int numThreads)
      throws IOException {
      mModel = model;
      if (model == Model.MULTI_CLASS_MODEL) {
          return new ClassifierMultiClassCustom(activity, device, numThreads);
      } else if (model == Model.MULTI_LABEL_MODEL) {
          return new ClassifierMultiLabelMobileNet(activity, device, numThreads);
      }
      else {
